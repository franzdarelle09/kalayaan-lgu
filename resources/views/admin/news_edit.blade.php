...
<div class="row justify-content-center">
    ...
    <div class="col-lg-10">
        <div class="card shadow-lg border-0 rounded-lg mt-5">
            <div class="card-header"><h4 class="text-center font-weight-light my-2">Edit News</h4></div>
            <div class="card-body">
                <form method="post" action="/administration/news/add"  enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="news_id" value="{{$n->id}}">
                    <input type="hidden" id="thumbnail-image" name="thumbnail_image" value="{{$n->small_thumb}}" />
                    <div class="form-group">
                        <label class="small mb-1" for="titlr">Title</label>
                        <input type="text" name="title" value="{{$n->title}}" class="form-control py-4">
                    </div>
                    
                    <div class="form-group">
                        <textarea class="ckeditor form-control" name="wysiwyg-editor">{{$n->body}}</textarea>
                    </div>
