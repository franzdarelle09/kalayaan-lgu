            ...
            <div class="nav">
                ...
                <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="/administration/documents">Document List</a>
                ...
                <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="/administration/news">News List</a>
                        <a class="nav-link" href="/administration/news/add">Add News</a>
                    </nav>
                </div>
                ...
                <div class="collapse" id="collapseLayouts4" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="/administration/announcements">Announcement List</a>
                        <a class="nav-link" href="/administration/announcements/create">Add Announcement</a>
                        {{-- <a class="nav-link" href="/administration/documents/add">Add Document</a> --}}
                    </nav>
                </div>
                <a class="nav-link" href="/administration/projects">
